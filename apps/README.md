...
|插件名|功能|下载|编译日期|
| :----: | :----: | :----: | :----: |
| [PassWall](https://github.com/xiaorouji/openwrt-passwall) | 科学工具 | [PassWall_26.5.20](https://github.com/AUK9527/Are-u-ok/raw/main/apps/all/PassWall_26.5.20_aarch64_a53_all_sdk_22.03.7.run) |2026-05-21|
| [PassWall2](https://github.com/xiaorouji/openwrt-passwall2) | 科学工具 | [PassWall2_26.5.19](https://github.com/AUK9527/Are-u-ok/raw/main/apps/all/PassWall2_26.5.19_aarch64_a53_all_sdk_22.03.7.run) |2026-05-19|
...
| [OpenClash](https://github.com/vernesong/OpenClash) | 科学工具 | [OpenClash_0.47.088](https://github.com/AUK9527/Are-u-ok/raw/main/apps/all/OpenClash_0.47.088+aarch64_core.run) |2026-05-12|
...
例
```console
sh PassWall_26.5.20_aarch64_a53_all_sdk_22.03.7.run
```
如果文件不在当前路径记得填写路径，下例
```console
sh /tmp/upload/PassWall_26.5.20_aarch64_a53_all_sdk_22.03.7.run
```
